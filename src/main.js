...
function endInteraction(reset = true) {
  ...
  $("#cafe").setAttribute("aria-label", "6匹の猫が暮らす3D猫カフェ");
  if (reset) cafe?.reset();
}
...
for (const [id, mode, effect, message] of [
  ["toy-btn", "play", "toy", "ころころ… おもちゃを追いかけよう！"],
